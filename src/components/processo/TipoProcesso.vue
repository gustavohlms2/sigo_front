    ...
    methods: {
        ...
        getExcluir: function(){
            ...
            var tipoprocessoAlterar = this.filteredTipoprocessos.filter(tipoprocesso => tipoprocesso.id == this.idExclusao )[0];
                tipoprocessoAlterar.dataAlteracao = dateFormat(new Date(), "yyyy-mm-dd hh:MM:ss");
                tipoprocessoAlterar.indativo = false;
            //axios.delete(url).then(function(r){
            axios.put(url, tipoprocessoAlterar).then(function(r){
                console.log(r);
        ...
        salvarAlterar(){
            ...
            if (this.tipoprocessoAlterar.id != '' && this.tipoprocessoAlterar.id != undefined ){
                url = url + this.tipoprocessoAlterar.id;
